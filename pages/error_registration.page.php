    ...
    <div class="col col-lg-4 col-md-6 col-sm-8">
        <div class="card card-forms">
            ...
            <div class="card-body border">
                <h6 class="text-center text-danger">Registration error!</h6>
                <p class="text-center text-danger">Please re-registar! </p>
            </div><!-- card-body -->
            <div class="card-footer card-footer-bg card-footer-margin">
                <div class="row justify-content-center justify-content-around">
                <a class="text-white" href="./registar" id="">Registar page</a>
                </div>
            </div>
        </div><!-- card -->
    </div><!-- col -->
