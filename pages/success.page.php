    ...
    <div class="col col-lg-4 col-md-6 col-sm-8">
        <div class="card card-forms border-0">
            ...
            <div class="card-body border">
                <h6 class="text-center text-success py-2">Verification mail is sent,check your mail. </h6>
                <p class="text-center text-danger py-2">Verification token expire after one hour!</p>
            </div><!-- card-body -->
